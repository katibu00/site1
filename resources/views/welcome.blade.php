			...
			<div class="container">
				<div class="header-inner">
					...
					<nav id="site-navigation" class="main-nav">
						...
						<div class="nav-right">
							<a href="login.html" class="nav-btn gp-btn color-two btn-circle">Try for Free</a>
		...
		<section class="banner banner-main">
			<div class="container">
				<div class="banner-main-content-wrapper">
					...
					<div class="banner-promo-mockup">
						<img src="/theme/media/banner/main/mockup.png" class="wow fadeInUp" data-wow-delay="0.7s" alt="Astriol">
					</div>
				</div>
			...
			<div class="banner-main-animate">
				<ul class="animate-items">
					<li><img src="/theme/media/banner/main/leaf1.png" alt="leaf"></li>
					<li><img src="/theme/media/banner/main/rabar.png" data-parallax='{"y": 200, "x": 100}' alt="leaf"></li>
					<li><img src="/theme/media/banner/main/angle.png" data-parallax='{ "x": -200, "rotateZ": 360}' alt="leaf"></li>
					<li><img src="/theme/media/banner/main/leaf3.png" data-parallax='{"y": 100, "x": 100}' alt="leaf"></li>
					<li><img src="/theme/media/banner/main/dot.png" alt="leaf"></li>
					<li><img src="/theme/media/banner/main/box.png" data-parallax='{"y": -200, "x": -100, "rotateZ": 360}' alt="leaf"></li>
					<li class="bubble1"></li>
					<li class="bubble2"></li>
					<li class="bubble3"></li>
					<li class="bubble4"></li>
					...
					<div class="col-lg-7">
						<div class="anime-image-wrapper">
							<div class="feature-image-wrap">
								<img src="/theme/media/feature/image4.png" class="wow zoom" alt="astriol feature">
							</div>
						</div>
						<!-- /.anime-image-wrapper -->
					</div>
					...
					<div class="col-lg-5">
						<div class="image-content-wrapper style-two">
							...
							<div class="author-info-single wow fadeInUp" data-wow-delay="0.7s">
								<div class="avatar">
									<img src="/theme/media/about/author.jpg" alt="author">
								</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-7">
						<div class="anime-image-wrapper style-four">
							<div class="feature-image-wrap">
								<img src="/theme/media/feature/iphonex.png" class="wow zoom" data-wow-delay="0.7s" alt="astriol feature">

								<div class="image-one" data-parallax='{"y": -60}'>
									<img src="/theme/media/feature/imagesm.png" class="wow fadeInDown" data-wow-delay="0.9s" alt="astriol">
								</div>
								<!-- /.image-one -->

								<div class="image-two" data-parallax='{"y": 60}'>
									<img src="/theme/media/feature/imagelong.png" class="wow fadeInUp" data-wow-delay="1.1s" alt="astriol">
								</div>
								<!-- /.image-two -->
							</div>
							...
							<div class="anime-dot">
								<img src="/theme/media/feature/dot3.png" class="wow fadeInRight" data-wow-delay="0.3s" alt="astrion dot">
							</div>
						</div>
						<!-- /.anime-image-wrapper -->
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-5">
						<div class="testimonial-wrap">
							<div class="quote">
								<img src="/theme/media/testimonial/quote2.png" alt="quote">
							</div>
									...
									<div class="swiper-slide">
										<div class="testimonial-cre">
											...
											<div class="testmonial-info">
												<div class="info-wrapper">
													<div class="user-avatar">
														<img src="/theme/media/testimonial/2.jpg" alt="astriol user-avatar">
													</div>
													<!-- /.user-avatar -->
				...
				<div class="row">
						...
						<article class="blog-post-one">
							<div class="feature-image">
								<a href="blog-single.html">
									<img src="/theme/media/blog/m1.jpg" alt="blog-thumb">
								</a>

								<div class="entry-content">
									<div class="author vcard">
										<a class="post-author" href="blog-single.html">
											<img alt="" src="/theme/media/blog/author.jpg" class="avatar avatar-30 photo" height="30" width="30">
											Mominul Islam
										</a>
									</div>
									<ul class="post-meta">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<article class="blog-post-one color-two">
							<div class="feature-image">
								<a href="blog-single.html">
									<img src="/theme/media/blog/m2.jpg" alt="blog-thumb">
								</a>
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<article class="blog-post-one color-three">
							<div class="feature-image">
								<a href="blog-single.html">
									<img src="/theme/media/blog/m3.jpg" alt="blog-thumb">
								</a>
							...
							<div class="col-md-7">
								<div class="action-image-wrapper">
									<div class="image-one wow fadeInRight">
										<img src="/theme/media/call-to-action/ac_1.png" data-parallax='{"x": -50}' alt="animated-image-one">
									</div>
									<div class="image-two wow fadeInLeft">
										<img src="/theme/media/call-to-action/ac_2.png" data-parallax='{"x": 50}' alt="animated-image-one">
									</div>
								</div>
							</div>
							<!-- /.col-md-6 -->
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="widget footer-widget widget-newsletter">
								<div class="footer-logo">
									<img src="/theme/img/logo-saas.png" alt="site-logo">
								</div>
								...
								<form action="php/newsletter.php" method="post" class="footer-newsletter-form wow pixFadeUp" data-gp-form="newsletter-subscribe" style="visibility: visible; animation-name: pixFadeUp;">
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="widget footer-widget">
								...
								<ul class="footer-menu">
									...
									<li><a href="index.html">Astriol</a></li>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="widget footer-widget">
								...
								<ul class="footer-menu">
									<li><a href="contact.html">Help Docs</a></li>
									<li><a href="faq.html">FAQ’s</a></li>
						...
						<div class="col-lg-2 col-md-6 col-sm-6">
							<div class="widget footer-widget">
								...
								<ul class="footer-menu">
									...
									<li><a href="service.html">Tour</a></li>
								</ul>
							</div>
							<!-- /.widget footer-widget -->
						</div>
			...
			<div class="site-info">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-md-6">
							<div class="copyright">
								<p class="copyright-text">Copyright © 2020 Astriol by <a href="https://gptheme.com">GpTheme</a>. All Rights Reserved</p>
							</div>
						</div>
						<!-- /.col-md-6 -->
