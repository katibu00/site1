...
<section id="call-to-action-three">
    <div class="container pr">
        <div class="action-vector">
            <img src="/theme/media/footer/action.png" class="wow fadeInLeft" alt="action">
        </div>
...
<footer id="footer-saas" class="gp-site-footer">
    <div class="container">
    ...
    <div class="footer-bottom-anime-shape">
        <div class="bottom-shape">
            <img src="/theme/media/footer/footer-saas.png" alt="Astriol Shape">
        </div>
    </div>
    <!-- /.footer-bottom-anime-shape -->
</footer>